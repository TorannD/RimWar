                    ...
                    if (wo.Faction.HostileTo(this.Faction))
                    {
                        ...
                        else
                        {
                            ...
                            if (settlement != null)
                            {
                                ...
                                this.Faction.TryAffectGoodwillWith(settlement.Faction, 30, false, false, null, null);
                                settlement.Faction.TryAffectGoodwillWith(this.Faction, 30, false, false, null, null);
                            }
